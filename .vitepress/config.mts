...
export default defineConfig({
  ...
  themeConfig: {
    logo: '/images/albirru-transparent.png',
    ...
    socialLinks: [
      { icon: 'youtube', link: 'https://www.youtube.com/@masjidal-birru' },
      { icon: 'instagram', link: 'https://www.instagram.com/masjid.albirru/' },
      { icon: {
        ...
        }, link: 'https://wa.me/6281399928319' }
    ],

    /* Footer kustom dirender via slot #layout-bottom (Layout.vue) */
